...
// Common base styles for all invoice templates
...
// Map of template types to their styles
export const templateStylesMap = {
  standard: standardStyles,
  premium: premiumStyles,
  platinum: platinumStyles
};
