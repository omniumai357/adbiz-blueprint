...
import { trackStepInteraction as trackStepInteractionUtil } from "../analytics/tour-analytics-utils";
...
export function useTourInteractions(
  ...
  // Use the trackStepInteraction utility if it doesn't exist in analytics
  const trackStepInteraction = analytics.trackStepInteraction || 
    ((pathData, stepData, stepIndex, interactionType, userId, userType) => {
      if (pathData && stepData) {
        return trackStepInteractionUtil(
          pathData, 
          stepData, 
          stepIndex, 
          interactionType, 
    ...
    switch (action) {
      ...
      case 'first':
        ...
        if (pathData && currentStepData) {
          trackStepInteraction(pathData, currentStepData, currentStep, 'jump_to_first', userId, userType);
        }
      ...
      case 'last':
        ...
        if (pathData && currentStepData) {
          trackStepInteraction(pathData, currentStepData, currentStep, 'jump_to_last', userId, userType);
        }
        // Implementation would go here
        break;
      case 'jump_forward':
        ...
        if (pathData && currentStepData) {
          trackStepInteraction(pathData, currentStepData, currentStep, 'jump_forward', userId, userType);
        }
        // Implementation would go here
        break;
      case 'jump_backward':
        ...
        if (pathData && currentStepData) {
          trackStepInteraction(pathData, currentStepData, currentStep, 'jump_backward', userId, userType);
        }
        // Implementation would go here
        break;
      case 'close':
  ...
  }, [buttonInteractions, trackStepInteraction, userId, userType, currentPath, currentStep, pathData, currentStepData]);
