    ...
    <div className="bg-white rounded-lg shadow-md p-4 md:p-6 max-w-4xl mx-auto">
                    ...
                    <FormItem>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        {[
                          ...
                          { id: "brandAwareness", label: "Increase brand awareness" },
                          { id: "higherBookings", label: "Increase bookings/appointments" },
                          { id: "websiteTraffic", label: "Drive website traffic" },
                          { id: "socialFollowers", label: "Grow social media following" },
                          { id: "competitorAdvantage", label: "Stand out from competitors" },
                          { id: "customerRetention", label: "Improve customer retention" },
                          { id: "expandGeographic", label: "Expand to new geographic areas" },
                          { id: "targetNewCustomers", label: "Target new customer segments" },
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea 
                          {...field} 
                          rows={3}
                          placeholder="What sets you apart from competitors? What are your unique selling points?" 
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea 
                          {...field} 
                          rows={2}
                          placeholder="List names of your main competitors" 
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
      ...
      <Sheet open={showReview} onOpenChange={setShowReview}>
        <SheetContent className="w-full md:max-w-xl">
          <SheetHeader>
            <SheetTitle>Questionnaire Review</SheetTitle>
            <SheetDescription>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="mt-2 space-y-2">
                  ...
                  <p><strong>Industry:</strong> {form.getValues("industry")}</p>
                  <p><strong>Years in Business:</strong> {form.getValues("yearsInBusiness")}</p>
                  <p><strong>Service Area:</strong> {form.getValues("serviceArea")}</p>
                  <p><strong>Description:</strong> {form.getValues("businessDescription")}</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-2 space-y-2">
                  ...
                  <p><strong>Website:</strong> {form.getValues("website") || "N/A"}</p>
                </div>
              </div>
              
              <div>
                <h3 className="text-lg font-medium">Marketing Goals</h3>
                <div className="mt-2">
                  <ul className="list-disc list-inside">
                    {form.getValues("marketingGoals")?.map((goal) => (
                      <li key={goal}>{goal}</li>
                    ))}
                  </ul>
                </div>
              ...
              <div>
                <h3 className="text-lg font-medium">Files to be Uploaded</h3>
                <div className="mt-2">
                  <p><strong>Logo:</strong> {files.logo ? files.logo.name : "None"}</p>
                  <p><strong>Images:</strong> {files.images.length} files</p>
                  <p><strong>Videos:</strong> {files.videos.length} files</p>
                  <p><strong>Documents:</strong> {files.documents.length} files</p>
                </div>
              </div>
            </div>
          </div>
